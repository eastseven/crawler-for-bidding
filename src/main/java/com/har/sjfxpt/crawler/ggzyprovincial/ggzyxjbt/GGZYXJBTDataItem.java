...
@Data
@ToString
@Document(collection = "data_item_ggzy_xjbt")
public class GGZYXJBTDataItem {

    public GGZYXJBTDataItem(String url) {
    ...
    public DataItemDTO dto() {
        ...
        dto.setSource(SourceCode.GGZYXJBT.getValue());
        dto.setSourceCode(SourceCode.GGZYXJBT.toString());
