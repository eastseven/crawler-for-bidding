...
@Data
@ToString
@Document(collection = "data_item_ggzy_fujian")@Deprecated
public class GGZYFuJianDataItem {


    public GGZYFuJianDataItem(String url) {
    ...
    public DataItemDTO dto() {
        ...
        dto.setSource(SourceCode.GGZYFUJIAN.getValue());
        dto.setSourceCode(SourceCode.GGZYFUJIAN.toString());
