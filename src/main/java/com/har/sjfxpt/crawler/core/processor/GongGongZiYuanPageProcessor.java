...
public class GongGongZiYuanPageProcessor implements BasePageProcessor {
    ...
    @Override
    public List<DataItemDTO> parseContent(Elements items) {
        List<DataItemDTO> dataItemList = Lists.newArrayList();
        ...
        for (Element item : items) {
            ...
            DataItemDTO dataItem = new DataItemDTO(href);
    ...
    public void handleContent(Page page) {
        ...
        List<DataItemDTO> dataItemList = parseContent(items);
