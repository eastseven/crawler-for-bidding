...
@Data
@ToString
@Document(collection = "data_item_chengdu_construction")
public class ChengDuConstructionDataItem {
    public ChengDuConstructionDataItem(String url) {
    ...
    public DataItemDTO dto() {
        ...
        dto.setSource(SourceCode.CDJS.getValue());
        dto.setSourceCode(SourceCode.CDJS.toString());
