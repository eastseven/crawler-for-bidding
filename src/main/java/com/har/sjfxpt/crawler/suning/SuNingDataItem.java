...
@Data
@ToString
@Document(collection = "data_item_su_ning")
public class SuNingDataItem {

    public SuNingDataItem(String url) {
    ...
    public DataItemDTO dto() {
        ...
        dto.setSource(SourceCode.SUNING.getValue());
        dto.setSourceCode(SourceCode.SUNING.toString());
