...
@Data
@ToString
@Document(collection = "data_item_zgrenshou")
public class ZGRenShouDataItem {


    public ZGRenShouDataItem(String url) {
    ...
    public DataItemDTO dto() {
        ...
        dto.setSource(SourceCode.ZGRENSHOU.getValue());
        dto.setSourceCode(SourceCode.ZGRENSHOU.toString());
