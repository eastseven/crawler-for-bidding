...
import com.har.sjfxpt.crawler.zgyj.SunWayWorldPageProcessor;
import lombok.extern.slf4j.Slf4j;
import org.springframework.stereotype.Component;
import org.springframework.util.Assert;
import us.codecraft.webmagic.downloader.HttpClientDownloader;

import static com.har.sjfxpt.crawler.zgly.ChinaIcoPageProcessor.*;
...
@Slf4j
@Component
@SourceConfig(code = SourceCode.ZGLVYE, useProxy = true, sources = {
...
public class ChinaIcoPageProcessor extends SunWayWorldPageProcessor {

    public static final String URL_01 = "http://ec.chalieco.com/b2b/web/two/indexinfoAction.do?actionType=showMoreZbs&xxposition=zbgg";
    public static final String URL_02 = "http://ec.chalieco.com/b2b/web/two/indexinfoAction.do?actionType=showMoreCgxx&xxposition=cgxx";
    public static final String URL_03 = "http://ec.chalieco.com/b2b/web/two/indexinfoAction.do?actionType=showMoreClarifypub&xxposition=cqgg";
    public static final String URL_04 = "http://ec.chalieco.com/b2b/web/two/indexinfoAction.do?actionType=showMorePub&xxposition=zhongbgg";
    ...
    public ChinaIcoPageProcessor(HttpClientDownloader httpClientDownloader, ProxyService proxyService) {
        ...
        setSourceCode(SourceCode.ZGLVYE);
        setDomain("http://ec.chalieco.com");
