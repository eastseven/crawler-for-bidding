...
import com.har.sjfxpt.crawler.ccgp.ccgphn.HaiNanSpiderLauncher;
...
public class SpiderLauncher implements CommandLineRunner {
    ...
    @Autowired
    HaiNanSpiderLauncher haiNanSpiderLauncher;
    ...
    public void info() {
        ...
        haiNanSpiderLauncher.printInfo();
